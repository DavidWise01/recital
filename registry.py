#!/usr/bin/env python3
"""Registry = the Anchoring layer. Ground truth of every passphrase, whether it
was shown to anyone, and when. JSONL + anchors/<hash>.json, per the family convention.
"""
...
class Registry:
    ...
    def shown(self):
        return [e for e in self.entries if e["exposure"] == "shown"]
